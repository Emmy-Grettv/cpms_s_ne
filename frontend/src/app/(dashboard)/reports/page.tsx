  ...
  return (
    <div className="w-full">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <h1 className="text-2xl font-bold text-sky-500">Parking Reports</h1>
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          ...
          <Input
            ...
            className="w-full sm:w-48"
          />
          <Button onClick={handleDateChange} disabled={isLoading} className="w-full sm:w-auto bg-sky-500">
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange}>
        <TabsList className="mb-4 w-full sm:w-auto">
          <TabsTrigger value="outgoing" className="flex-1 sm:flex-none text-sky-500">Outgoing Cars</TabsTrigger>
          <TabsTrigger value="entered" className="flex-1 sm:flex-none text-sky-500">Entered Cars</TabsTrigger>
        </TabsList>
          ...
          <Card className="p-6">
            {reportData?.data.summary && (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                <div className="bg-[#f1f5f9] p-4 rounded-lg">
                  <h3 className="text-sm font-medium text-sky-500">Total Cars</h3>
                  <p className="text-2xl font-bold">{reportData.data.summary.totalCars}</p>
                </div>
                <div className="bg-[#f1f5f9] p-4 rounded-lg">
                  <h3 className="text-sm font-medium text-sky-500">Total Amount</h3>
                  <p className="text-2xl font-bold">
                    {formatAmount(parseFloat(reportData.data.summary.totalAmount || "0"))}
                  </p>
                </div>
                <div className="bg-[#f1f5f9] p-4 rounded-lg">
                  <h3 className="text-sm font-medium text-sky-500">Date Range</h3>
                  <p className="text-sm">
            ...
            <div className="overflow-x-auto">
              <Table>
                <TableHeader>
                  <TableRow>
                    <TableHead className="text-sky-500">Ticket #</TableHead>
                    <TableHead className="text-sky-500">Plate Number</TableHead>
                    <TableHead className="hidden md:table-cell text-sky-500">Parking Slot</TableHead>
                    <TableHead className="hidden lg:table-cell text-sky-500">Entry Time</TableHead>
                    <TableHead className="hidden lg:table-cell text-sky-500">Exit Time</TableHead>
                    <TableHead className="hidden md:table-cell text-sky-500 text-right">Amount</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
            ...
            {reportData?.data.summary && (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                <div className="bg-primary/10 p-4 rounded-lg">
                  <h3 className="text-sm font-medium tex-sky-500">Total Cars</h3>
                  <p className="text-2xl font-bold">{reportData.data.summary.totalCars}</p>
                </div>
                <div className="bg-primary/10 p-4 rounded-lg">
                  <h3 className="text-sm font-medium tex-sky-500">Active Cars</h3>
                  <p className="text-2xl font-bold">{reportData.data.summary.activeCars}</p>
                </div>
                <div className="bg-primary/10 p-4 rounded-lg">
                  <h3 className="text-sm font-medium tex-sky-500">Exited Cars</h3>
                  <p className="text-2xl font-bold">{reportData.data.summary.exitedCars}</p>
                </div>
                <div className="bg-primary/10 p-4 rounded-lg">
                  <h3 className="text-sm font-medium tex-sky-500">Total Revenue</h3>
                  <p className="text-2xl font-bold">
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="hidden lg:table-cell text-sky-500">Entry Time</TableHead>
                    <TableHead className="hidden lg:table-cell text-sky-500">Exit Time</TableHead>
                    <TableHead className="hidden md:table-cell text-right text-sky-500">Amount</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
