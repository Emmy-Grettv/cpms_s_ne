  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-center">
        <h2 className="text-2xl font-bold text-sky-500">Car Entries & Exits</h2>
      </div>
  ...
  <form onSubmit={handleSubmit} className="space-y-6">
    <div className="flex flex-col gap-6">
      <div className="flex flex-col">
        <label htmlFor="plate_number" className="mb-1 font-medium text-sm text-sky-500">
          Select Vehicle
        </label>
        <select
          name="plate_number"
          ...
          required
          className="p-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-sky-400 bg-white"
        >
      ...
      <div className="flex flex-col">
        <label htmlFor="parking_code" className="mb-1 font-medium text-sm text-sky-500">
          Parking Code
        </label>
        <select
          name="parking_code"
          ...
          className="p-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-sky-400 bg-white "
        >
          <option value="">Choose parking code...</option>
          {parkingSlots.map((slot) => (
            <option key={slot.code} value={slot.code} disabled={slot.available_spaces === 0}>
      ...
      <div className="flex justify-end">
        <Button
          type="submit"
          disabled={submitting || !form.parking_code || !form.plate_number}
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b bg-gray-50">
                  <th className="p-4 text-left font-medium text-sky-500">
                    Ticket
                  </th>
                  <th className="p-4 text-left font-medium text-sky-500">
                    Plate Number
                  </th>
                  <th className="hidden md:table-cell p-4 text-left font-medium text-sky-500">
                    Parking Code
                  </th>
                  <th className="hidden lg:table-cell p-4 text-left font-medium text-sky-500">
                    Entry Time
                  </th>
                  <th className="hidden lg:table-cell p-4 text-left font-medium text-sky-500">
                    Exit Time
