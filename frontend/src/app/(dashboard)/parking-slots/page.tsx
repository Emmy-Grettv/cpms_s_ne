...
export default function ParkingSlotsPage() {
    ...
    return (
      <div className="space-y-8 relative">
        ...
        {showModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-white/30 backdrop-blur-xs">
            <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-md relative">
              ...
              <h2 className="text-xl font-semibold mb-4 text-sky-500">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button type="submit" disabled={submitting} className="w-full bg-sky-500">
                  {submitting
                    ? editingSlot
                      ? "Updating..."
                      : "Adding..."
        ...
        <div className="max-w-3xl mx-auto">
          <h2 className="text-xl font-semibold mb-4 text-sky-500">Parking Slots</h2>
          <div className="mb-4">
            <Input
  ...
  return (
    <div className="space-y-8">
      <h2 className="text-xl font-semibold mb-4 text-sky-500">Available Parking Slots</h2>
      {loading ? (
